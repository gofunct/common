...
var Init = assets.NewFileSystem(map[string][]string{"/cmd": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/app": []string{"run.go.tmpl"}, "/api": []string{}, "/api/protos/type": []string{".keep.tmpl"}, "/": []string{"Gopkg.toml.tmpl", ".gitignore.tmpl", "gogen.toml.tmpl"}, "/app/server": []string{".keep.tmpl"}, "/api/protos": []string{".keep.tmpl"}}, map[string]*assets.File{
